import { Utensils, Cpu, Shirt, Music2, Salad, Mountain, type LucideIcon } from "lucide-react-native";

/** Mirrors client/enums/event-category.enum.ts - same category set, RN icon set. */
...
/** Icon + accent colors used on category tiles when no photo is supplied. */
export const CATEGORY_VISUAL: Record<EventCategory, { icon: LucideIcon; from: string; to: string }> = {
