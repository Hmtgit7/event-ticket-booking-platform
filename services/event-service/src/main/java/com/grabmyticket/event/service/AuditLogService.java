...
import com.grabmyticket.event.dto.AdminAuditLogResponse;
import com.grabmyticket.event.dto.PageResponse;
import com.grabmyticket.event.entity.AdminAuditLog;
import com.grabmyticket.event.repository.AdminAuditLogRepository;

/** The one place this service ever writes an audit entry - same pattern as auth-service's and booking-service's AuditLogService. */
@Service
