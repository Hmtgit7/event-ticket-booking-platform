...
/**
 * Same logic as every other service's JwtAuthenticationFilter (copied, not
 * shared as a library, to keep each service independently deployable).
 * Reads "Authorization: Bearer <token>", validates it, populates
